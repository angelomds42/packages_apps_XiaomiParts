...
public class Startup extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
                ...
                ComponentUtils.toggleComponent(context, AutoHbmTileService.class,
                                AutoHbmFragment.isHbmSupported(context));
                ...
                ComponentUtils.toggleComponent(context, AutoDcDimmingActivity.class,
                                AutoDcDimmingFragment.isDcDimmingSupported(context));
                ComponentUtils.toggleComponent(context, AutoDcDimmingTileService.class,
                                AutoDcDimmingFragment.isDcDimmingSupported(context));
                ...
                ComponentUtils.toggleComponent(context, ThermalActivity.class,
                                ThermalUtils.isThermalSupported(context));
                ...
                ComponentUtils.toggleComponent(context, org.lineageos.settings.refreshrate.RefreshActivity.class,
                                isRefreshProfilesSupported);
                ComponentUtils.toggleComponent(context, org.lineageos.settings.refreshrate.RefreshTileService.class,
                                isRefreshProfilesSupported);
