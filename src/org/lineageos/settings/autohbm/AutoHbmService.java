...
public class AutoHbmService extends Service {
    ...
    private void enableHbm(boolean enable) {
        String node = Constants.getHbmNode(getApplicationContext());
        FileUtils.writeValue(node, enable ? "1" : "0");
    }

    private boolean isCurrentlyEnabled() {
        String node = Constants.getHbmNode(getApplicationContext());
        String fileValue = FileUtils.getFileValue(node, "0");
        return "1".equals(fileValue);
    }
