...
public class ComponentUtils {
     ...
     * @param preferenceKey The key of the SharedPreferences that controls the
     *                      service.
     * @param serviceClass  The class of the service to control.
     */
    public static void toggleService(Context context, boolean isSupported, String preferenceKey,
            Class<?> serviceClass) {
        if (!isSupported) {
            return;
        }
     ...
     *
     * @param context        The context from which the component will be enabled or
     *                       disabled.
     * @param componentClass The class of the component to be enabled or disabled.
     * @param enable         If true, the component will be enabled; if false, it
     *                       will be disabled.
     */
